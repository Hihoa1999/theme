            ...
            <div class="panel panel-login">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <a href="#" id="register-form-link">Đăng Ký Thành Viên</a>
                        </div>
                    </div>
                    <hr>
                </div>
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        <f:button name="login-submit"  id="login-submit" tabindex="4" class="form-control btn btn-login">Đăng Nhập</f:button>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="text-center">
                                                <a href="quenmatkhau.htm" tabindex="5" class="forgot-password">Quên Mật Khẩu?</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <f:form id="register-form" type="reset" commandName="khachHang" action="dangKyKhachHang.htm" method="post" role="form" style="display: none;">
                            ...
                            <div class="form-group">
                                <f:input type="password" path="nhapLaiMatKhau" id="username" tabindex="1" class="form-control" placeholder="Nhập Lại Mật Khẩu" value="" required="required"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        <f:button name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="Register Now">Ghi Danh</f:button>
                                        </div>
                                    </div>
                                </div>
                        </f:form>
