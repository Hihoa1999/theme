                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td><h5 class="product-price">Mật khẩu:</h5></td>
                                         <td><h1 class="product-name">&nbsp; </h1></td>
                                        <td><h5 class="product-price"><f:input type='password' path="matKhau"/></h5></td>
                                    </tr>
                                    <tr>
                                        <td><h5 class="product-price">Nhập Lại Mật Khẩu:</h5></td>
                                         <td><h1 class="product-name">&nbsp; </h1></td>
                                        <td><h5 class="product-price"><f:input type='password' path="nhapLaiMatKhau"/></h5></td>
