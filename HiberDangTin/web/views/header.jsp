...
<div id="top-header">
    <div class="container">
        <div class="pull-left">
            <span>Chào mừng đến với My Home</span>
        </div>
    </div>
</div>
<div id="header">
    <div class="container">
        <div class="pull-left">
            <form action="searchphongtro.htm" method="get">
                Tìm kiếm: <input class="input search-input" type="text" name="tenpt" placeholder="Nhập từ khóa">
            </form>
        </div>
            ...
            <ul class="header-btns">
                ...
                <li class="header-account dropdown default-dropdown">
                    ...
                    <ul class="custom-menu">
                        ...
                        <li><a href = "hopthu.htm?maKh=<%=session.getAttribute("ma")%>"><i class="fa fa-check"></i> Hộp Thư</a></li>
                        <li><a href = "taomoiPt.htm"><i class="fa fa-heart-o"></i> Đăng Tin</a></li>
                    </ul>
                    <% } else { %>
                ...
                <!-- Cart -->
                 ...
                 <jsp:include page="donate.jsp" flush="true"></jsp:include> 
